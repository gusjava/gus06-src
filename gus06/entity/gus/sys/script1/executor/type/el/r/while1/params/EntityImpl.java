package gus06.entity.gus.sys.script1.executor.type.el.r.while1.params;
...
public class EntityImpl implements Entity, T {
	...
	public static final String RULE = "[while] with [map]|[while]";
	...
	public Object t(Object obj) throws Exception
	{
		...
		if(has(data,"map"))
		{
			...
			transfer(map,m,K_IF);
			transfer(map,m,K_MIN);
			transfer(map,m,K_MAX);
		}
		return m;
	}
