package gus06.entity.gus.sys.script1.executor.type.el.r.clock;
...
public class EntityImpl implements Entity, T {
	...
	private void sleepForLapse(Integer n)
	{
		if(n==null || n.intValue()==0) return;
		
		try{Thread.sleep(n.intValue());}
		catch(Exception e){Outside.err(this,"sleepForLapse(Integer)",e);}
	}
}
