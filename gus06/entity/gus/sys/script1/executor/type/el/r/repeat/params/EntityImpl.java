package gus06.entity.gus.sys.script1.executor.type.el.r.repeat.params;
...
public class EntityImpl implements Entity, T {
	...
	public static final String RULE = "[times] with [map]|[times]";
	...
	public Object t(Object obj) throws Exception
	{
		...
		if(has(data,"map"))
		{
			...
			transfer(map,m,K_VAR);
			transfer(map,m,K_REDIRECT);
			transfer(map,m,K_WHILE);
			transfer(map,m,K_UNTIL);
			transfer(map,m,K_SKIP);
			transfer(map,m,K_IF);
		}
		return m;
	}
