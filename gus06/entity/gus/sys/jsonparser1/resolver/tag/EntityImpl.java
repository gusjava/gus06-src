package gus06.entity.gus.sys.jsonparser1.resolver.tag;
...
public class EntityImpl implements Entity, T {
	...
	{
		resolveGroup2 = Outside.service(this,"gus.sys.jsonparser1.resolver.tag.group2");
		resolveGroup3 = Outside.service(this,"gus.sys.jsonparser1.resolver.tag.group3");
	}
