package gus06.entity.gus.sys.expression1.apply.op._findall_bf0_st_n;
...
public class EntityImpl implements Entity, T {
	...
	{
		builder = Outside.service(this,"gus.filter.string.build.startswith_n");
		perform = Outside.service(this,"gus.list.findall.before0.first");
	}
