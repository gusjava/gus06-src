package gus06.entity.gus.sys.expression1.apply.op._extract_quote2_a;
...
public class EntityImpl implements Entity, T {
	...
	public EntityImpl() throws Exception
	{
		...
		String regex = (String) regexFromRule.r(KEY_QUOTE2);
	...
	private List extract(String data) throws Exception
	{
