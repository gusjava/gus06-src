package gus06.entity.gus.sys.expression1.apply.op._e_eachvalue_w;
...
public class EntityImpl implements Entity, T {
	...
	public EntityImpl() throws Exception
	{
		...
		perform = Outside.service(this,"gus.data.perform.eachvalue");
		wrap = Outside.service(this,"gus.feature.wrap.fp.p");
	}
