package gus06.entity.gus.sys.filetool.ext.dirextviewer1.holder;
...
public class EntityImpl implements Entity, I, P, Runnable {
	...
	public EntityImpl() throws Exception
	{
		...
		computeExt = Outside.service(this,"gus.dir.listing.dirtomap.file_extmap");
		buildTreeTable = Outside.service(this,"gus.sys.treetable1.extmap");
