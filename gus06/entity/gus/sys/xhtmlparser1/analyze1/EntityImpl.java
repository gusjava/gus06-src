package gus06.entity.gus.sys.xhtmlparser1.analyze1;
...
//	public static final String K_PREVTAG = "prevtag";
	...
	{
		buildTagText = Outside.service(this,"gus.sys.xhtmlparser1.analyze1.buildtag.text");
		buildTagElement = Outside.service(this,"gus.sys.xhtmlparser1.analyze1.buildtag.element");
	}
