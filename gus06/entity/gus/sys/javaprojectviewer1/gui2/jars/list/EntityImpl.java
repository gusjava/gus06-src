package gus06.entity.gus.sys.javaprojectviewer1.gui2.jars.list;
...
public class EntityImpl extends S1 implements Entity, I, P, G, ActionListener {
	...
	{
		control = Outside.service(this,"*gus.sys.javaprojectviewer1.gui2.jars.list.control");
		rendering = Outside.service(this,"gus.sys.javaprojectviewer1.gui2.jars.list.rendering");
		updater = Outside.service(this,"gus.sys.javaprojectviewer1.gui2.jars.list.updater");
