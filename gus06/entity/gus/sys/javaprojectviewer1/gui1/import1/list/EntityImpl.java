package gus06.entity.gus.sys.javaprojectviewer1.gui1.import1.list;
...
public class EntityImpl extends S1 implements Entity, I, P, G, ActionListener {
	...
	{
		control = Outside.service(this,"*gus.sys.javaprojectviewer1.gui1.import1.list.control");
		rendering = Outside.service(this,"gus.sys.javaprojectviewer1.gui1.import1.list.rendering");
		updater = Outside.service(this,"gus.sys.javaprojectviewer1.gui1.import1.list.updater");
