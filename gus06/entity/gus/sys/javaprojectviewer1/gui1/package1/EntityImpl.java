package gus06.entity.gus.sys.javaprojectviewer1.gui1.package1;
...
public class EntityImpl implements Entity, I, P, ActionListener {
	...
	{
		list = Outside.service(this,"*gus.sys.javaprojectviewer1.gui1.package1.list");
		table = Outside.service(this,"*gus.sys.javaprojectviewer1.gui1.class1");
