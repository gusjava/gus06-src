package gus06.entity.gus.swing.textcomp.cust.action.ctrl_x.cut.perform;
...
public class EntityImpl implements Entity, P {
	...
	public EntityImpl() throws Exception
	{
		...
		highlight = Outside.service(this,"gus.swing.textcomp.cust.action.ctrl_x.cut.perform.highlightpainter");
	}
