package gus06.entity.gus.swing.textcomp.cust.action.ctrl_b.execute.perform2;
...
public class EntityImpl implements Entity, P {
	...
	{
		openFile = Outside.service(this,"gus.swing.textcomp.cust.action.ctrl_b.execute.perform2.openfile");
		openURL = Outside.service(this,"gus.swing.textcomp.cust.action.ctrl_b.execute.perform2.openurl");
		openURL2 = Outside.service(this,"gus.swing.textcomp.cust.action.ctrl_b.execute.perform2.openurl2");
		browse = Outside.service(this,"gus.swing.textcomp.cust.action.ctrl_b.execute.perform2.browse");
