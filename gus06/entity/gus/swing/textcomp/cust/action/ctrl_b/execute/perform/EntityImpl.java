package gus06.entity.gus.swing.textcomp.cust.action.ctrl_b.execute.perform;
...
public class EntityImpl implements Entity, P {
	...
	{
		perform2 = Outside.service(this,"gus.swing.textcomp.cust.action.ctrl_b.execute.perform2");
	}
