package gus06.entity.gus.swing.textcomp.cust.action.f_shift.search;
...
public class EntityImpl implements Entity, P {
	...
	public static final KeyStroke KEYSTROKE = KeyStroke.getKeyStroke(KeyEvent.VK_F,Event.CTRL_MASK + KeyEvent.SHIFT_MASK);
	
	
	private Service perform;
	
	public EntityImpl() throws Exception
	{perform = Outside.service(this,"gus.swing.textcomp.cust.action.f_shift.search.perform");}
