package gus06.entity.gus.swing.textcomp.cust.action.r_shift.keepline.focus.perform.caret;
...
public class EntityImpl implements Entity, P {
	...
	{
		highlight = Outside.service(this,"gus.swing.textcomp.cust.action.r_shift.keepline.focus.perform.caret.painter");
		keepWord = Outside.service(this,"gus.swing.textcomp.cust.action.r_shift.keepline.focus.perform.caret.keepword");
