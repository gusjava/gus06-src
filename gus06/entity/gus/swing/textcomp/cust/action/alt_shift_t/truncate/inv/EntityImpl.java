package gus06.entity.gus.swing.textcomp.cust.action.alt_shift_t.truncate.inv;
...
public class EntityImpl implements Entity, P {
	...
	{
		perform = Outside.service(this,"gus.swing.textcomp.cust.action.alt_shift_t.truncate.inv.perform");
