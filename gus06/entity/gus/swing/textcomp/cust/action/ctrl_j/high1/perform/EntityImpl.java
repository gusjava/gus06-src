package gus06.entity.gus.swing.textcomp.cust.action.ctrl_j.high1.perform;
...
public class EntityImpl implements Entity, P {
	...
	{
		performCaret = Outside.service(this,"gus.swing.textcomp.cust.action.ctrl_j.high1.perform.caret");
		performSelection = Outside.service(this,"gus.swing.textcomp.cust.action.ctrl_j.high1.perform.selection");
		performAll = Outside.service(this,"gus.swing.textcomp.cust.action.ctrl_j.high1.perform.all");
