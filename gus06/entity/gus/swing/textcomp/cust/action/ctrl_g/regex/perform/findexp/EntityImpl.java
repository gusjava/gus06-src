package gus06.entity.gus.swing.textcomp.cust.action.ctrl_g.regex.perform.findexp;
...
public class EntityImpl implements Entity, T {
	...
	public EntityImpl() throws Exception
	{
		...
		ask = Outside.service(this,"gus.swing.textcomp.cust.action.ctrl_g.regex.perform.findexp.ask");
	}
