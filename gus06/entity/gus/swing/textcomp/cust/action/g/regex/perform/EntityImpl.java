package gus06.entity.gus.swing.textcomp.cust.action.g.regex.perform;
...
public class EntityImpl implements Entity, P {
	...
	public EntityImpl() throws Exception
	{
		...
		findExp = Outside.service(this,"gus.swing.textcomp.cust.action.g.regex.perform.findexp");
