...
public class EntityImpl implements Entity, P {
	...
	{
		selectionMono = Outside.service(this,"gus.swing.textcomp.cust.action.d.removeline.perform.selection.mono");
		selectionMulti = Outside.service(this,"gus.swing.textcomp.cust.action.d.removeline.perform.selection.multi");
		caret = Outside.service(this,"gus.swing.textcomp.cust.action.d.removeline.perform.caret");
	}
