package gus06.entity.gus.swing.textcomp.cust.action.ctrl_r.keepline.perform.focus.selection.mono;
...
public class EntityImpl implements Entity, P {
	...
	public EntityImpl() throws Exception
	{
		...
		focusSelection = Outside.service(this,"gus.swing.textcomp.cust.action.ctrl_q.keepselection.perform.focus.selection");
	}
