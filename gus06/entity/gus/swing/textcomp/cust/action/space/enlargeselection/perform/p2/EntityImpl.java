package gus06.entity.gus.swing.textcomp.cust.action.space.enlargeselection.perform.p2;
...
public class EntityImpl implements Entity, P {
	...
	public EntityImpl() throws Exception
	{
		...
		perform_xml = Outside.service(this,"gus.swing.textcomp.cust.action.space.enlargeselection.perform.xml");
	}
