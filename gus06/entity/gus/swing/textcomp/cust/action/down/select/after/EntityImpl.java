package gus06.entity.gus.swing.textcomp.cust.action.down.select.after;
...
public class EntityImpl implements Entity, P {
	...
	public static final KeyStroke KEYSTROKE = KeyStroke.getKeyStroke(KeyEvent.VK_DOWN,Event.CTRL_MASK);
	
	
	private Service perform;
	
	public EntityImpl() throws Exception
	{perform = Outside.service(this,"gus.swing.textcomp.cust.action.down.select.after.perform");}
