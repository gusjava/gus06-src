package gus06.entity.gus.swing.textcomp.cust.action.ctrl_space.enlargeselection.perform;
...
public class EntityImpl implements Entity, P {
	...
	{
		findLevel = Outside.service(this,"gus.swing.textcomp.cust.action.ctrl_space.enlargeselection.findlevel");
		
		perform_p0 = Outside.service(this,"gus.swing.textcomp.cust.action.ctrl_space.enlargeselection.perform.p0");
		perform_p1 = Outside.service(this,"gus.swing.textcomp.cust.action.ctrl_space.enlargeselection.perform.p1");
		...
		perform_p4 = Outside.service(this,"gus.swing.textcomp.cust.action.ctrl_space.enlargeselection.perform.p4");
	}
