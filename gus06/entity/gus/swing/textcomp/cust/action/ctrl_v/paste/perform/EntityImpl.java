package gus06.entity.gus.swing.textcomp.cust.action.ctrl_v.paste.perform;
...
public class EntityImpl implements Entity, P {
	...
	public EntityImpl() throws Exception
	{
		...
		highlight = Outside.service(this,"gus.swing.textcomp.cust.action.ctrl_v.paste.perform.highlightpainter");
	}
