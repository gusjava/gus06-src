...
public class EntityImpl implements Entity, P {
	...
	{
		selectionMono = Outside.service(this,"gus.swing.textcomp.cust.action.e.doubleline.perform.selection.mono");
		selectionMulti = Outside.service(this,"gus.swing.textcomp.cust.action.e.doubleline.perform.selection.multi");
		caret = Outside.service(this,"gus.swing.textcomp.cust.action.e.doubleline.perform.caret");
	}
