package gus06.entity.gus.swing.textcomp.cust.action.e.doubleline;
...
public class EntityImpl implements Entity, P {
	...
	public static final KeyStroke KEYSTROKE = KeyStroke.getKeyStroke(KeyEvent.VK_E,Event.CTRL_MASK);
	
	
	private Service perform;
	
	public EntityImpl() throws Exception
	{perform = Outside.service(this,"gus.swing.textcomp.cust.action.e.doubleline.perform");}
