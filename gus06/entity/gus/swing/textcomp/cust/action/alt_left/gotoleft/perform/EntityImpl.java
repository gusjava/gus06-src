...
public class EntityImpl implements Entity, P {
	...
	{
		performSelection = Outside.service(this,"gus.swing.textcomp.cust.action.alt_left.gotoleft.perform.selection");
		performCaret = Outside.service(this,"gus.swing.textcomp.cust.action.alt_left.gotoleft.perform.caret");
	}
