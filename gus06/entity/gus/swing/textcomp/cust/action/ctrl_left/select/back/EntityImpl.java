package gus06.entity.gus.swing.textcomp.cust.action.ctrl_left.select.back;
...
public class EntityImpl implements Entity, P {
	...
	{
		perform = Outside.service(this,"gus.swing.textcomp.cust.action.ctrl_left.select.back.perform");
