package gus06.entity.gus.swing.textcomp.cust.action.ctrl_w.quickreplace.t;
...
public class EntityImpl implements Entity, T {
	...
	{
		byRegex = Outside.service(this,"gus.sys.quickreplace.t.byregex");
		byPosition = Outside.service(this,"gus.sys.quickreplace.t.byposition");
	}
