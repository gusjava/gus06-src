package gus06.entity.gus.swing.tree.perform.file.pastecontent;
...
public class EntityImpl implements Entity, P {
	...
	{
		toDir = Outside.service(this,"gus.sys.clipboard1.todir.writecontent");
		toFile = Outside.service(this,"gus.sys.clipboard1.tofile.writecontent");
	}
