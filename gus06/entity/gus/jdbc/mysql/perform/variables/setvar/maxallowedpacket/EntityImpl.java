package gus06.entity.gus.jdbc.mysql.perform.variables.setvar.maxallowedpacket;
...
public class EntityImpl implements Entity, P {
	...
	{
		buildSql = Outside.service(this,"gus.jdbc.mysql.sql.variables.setvar.maxallowedpacket");
