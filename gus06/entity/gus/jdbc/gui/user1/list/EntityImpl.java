package gus06.entity.gus.jdbc.gui.user1.list;
...
public class EntityImpl extends S1 implements Entity, I, P, G, ActionListener {
	...
	{
		control = Outside.service(this,"*gus.jdbc.gui.user1.list.control");
		rendering = Outside.service(this,"gus.jdbc.gui.user1.list.rendering");
		updater = Outside.service(this,"gus.jdbc.gui.user1.list.updater");
