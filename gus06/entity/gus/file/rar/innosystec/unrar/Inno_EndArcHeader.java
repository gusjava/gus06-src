...
public class Inno_EndArcHeader extends Inno_BaseBlock{
	...
	public Inno_EndArcHeader(Inno_BaseBlock bb, byte[] endArcHeader){
		super(bb);
		
		int pos = 0;
		if(hasArchiveDataCRC()){
			archiveDataCRC =Inno_Raw.readIntLittleEndian(endArcHeader, pos);
			pos+=4;
		}
		if(hasVolumeNumber()){
			volumeNumber = Inno_Raw.readShortLittleEndian(endArcHeader, pos);
		}
	}
