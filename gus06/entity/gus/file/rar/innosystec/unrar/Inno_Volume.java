...
public class Inno_Volume {
	
	private Inno_Volume() {}

	public static boolean mergeArchive(Inno_Archive archive, Inno_ComprDataIO dataIO) throws IOException
	{
		Inno_FileHeader hd = dataIO.getSubHeader();
		...
		Inno_UnrarCallback callback = archive.getUnrarCallback();
