package gus06.entity.gus.web.allocine.api.movie;
...
public class EntityImpl implements Entity, T {
	...
	public static final String URLROOT = "http://api.allocine.fr/rest/v3/movie";
	...
	public Object t(Object obj) throws Exception
	{
		...
		String params = "partner="+PARTNER_KEY+"&code="+encode(code)+"&format=json&filter=movie&profile=small&sed="+today();
