...
public class DIACRITICS_CAMEL {
	...
	private static boolean handle(StringBuilder b, char c, boolean z)
	{
		...
		case '\u00e0':b.append(z?'A':'a');break;//à accent grave
		case '\u00e1':b.append(z?'A':'a');break;//á accent aigu
		case '\u00e2':b.append(z?'A':'a');break;//â accent circonflexe
		case '\u00e3':b.append(z?'A':'a');break;//ã tilde
		case '\u00e4':b.append(z?'A':'a');break;//ä tréma
		case '\u00e5':b.append(z?'A':'a');break;//å rond en chef
		case '\u0101':b.append(z?'A':'a');break;//a macron (accent plat)
		case '\u0103':b.append(z?'A':'a');break;//a brève (accent goutte)
		...
		case '\u00e6':b.append(z?"Ae":"ae");break;//æ
		case '\u01fd':b.append(z?"Ae":"ae");break;//æ accent aigu
		case '\u01e3':b.append(z?"Ae":"ae");break;//æ macron
		...
		case '\u00e7':b.append(z?'C':'c');break;//ç cédille
		...
		case '\u00f0':b.append(z?'C':'c');break;//ð barre
		...
		case '\u1e11':b.append(z?'D':'d');break;//d cédille
		
		case '\u00e8':b.append(z?'E':'e');break;//è accent grave
		case '\u00e9':b.append(z?'E':'e');break;//é accent aigu
		case '\u00ea':b.append(z?'E':'e');break;//ê accent circonflexe
		case '\u00eb':b.append(z?'E':'e');break;//ë tréma
		case '\u0113':b.append(z?'E':'e');break;//e macron
		case '\u0115':b.append(z?'E':'e');break;//e brève
		case '\u0117':b.append(z?'E':'e');break;//e point suscrit
		case '\u0119':b.append(z?'E':'e');break;//e ogonek
		case '\u011b':b.append(z?'E':'e');break;//e hatchek
		case '\u0229':b.append(z?'E':'e');break;//e cédille
		...
		case '\u011f':b.append(z?'G':'g');break;//g brève
		case '\u0121':b.append(z?'G':'g');break;//g point suscrit
		case '\u0123':b.append(z?'G':'g');break;//g cédille
		...
		case '\u1e27':b.append(z?'H':'h');break;//h tréma
		case '\u1e29':b.append(z?'H':'h');break;//h cédille
		case '\u021f':b.append(z?'H':'h');break;//h hatchek
		
		case '\u00ec':b.append(z?'I':'i');break;//ì accent grave
		case '\u00ed':b.append(z?'I':'i');break;//í accent aigu
		case '\u00ee':b.append(z?'I':'i');break;//î accent circonflexe
		case '\u00ef':b.append(z?'I':'i');break;//ï tréma
		case '\u01d0':b.append(z?'I':'i');break;//i hatchek
		case '\u0129':b.append(z?'I':'i');break;//i tilde
		case '\u012b':b.append(z?'I':'i');break;//i macron
		case '\u012d':b.append(z?'I':'i');break;//i brève
		...
		case '\u0137':b.append(z?'K':'k');break;//k cédille
		...
		case '\u013c':b.append(z?'L':'l');break;//l cédille
		...
		case '\u00f1':b.append(z?'N':'n');break;//ñ tilde
		case '\u0144':b.append(z?'N':'n');break;//n accent aigu
		case '\u0146':b.append(z?'N':'n');break;//n cédille
		case '\u0148':b.append(z?'N':'n');break;//n hatchek
		
		case '\u00f2':b.append(z?'O':'o');break;//ò accent grave
		case '\u00f3':b.append(z?'O':'o');break;//ó accent aigu
		case '\u00f4':b.append(z?'O':'o');break;//ô accent circonflexe
		case '\u00f5':b.append(z?'O':'o');break;//õ tilde
		case '\u00f6':b.append(z?'O':'o');break;//ö tréma
		case '\u00f8':b.append(z?'O':'o');break;//ø barre
		case '\u014d':b.append(z?'O':'o');break;//o macron
		case '\u014f':b.append(z?'O':'o');break;//o brève
		...
		case '\u0153':b.append(z?"Oe":"oe");break;//œ
		...
		case '\u0157':b.append(z?'R':'r');break;//r cédille
		...
		case '\u015f':b.append(z?'S':'s');break;//s cédille
		case '\u0161':b.append(z?'S':'s');break;//š hatchek
		...
		case '\u0163':b.append(z?'T':'t');break;//t cédille
		...
		case '\u1e97':b.append(z?'T':'t');break;//t tréma
		
		case '\u1ee5':b.append(z?'U':'u');break;//u point souscrit
		case '\u00f9':b.append(z?'U':'u');break;//ù accent grave
		case '\u00fa':b.append(z?'U':'u');break;//ú accent aigu
		case '\u00fb':b.append(z?'U':'u');break;//û accent circonflexe
		case '\u00fc':b.append(z?'U':'u');break;//ü tréma
		case '\u0169':b.append(z?'U':'u');break;//u tilde
		case '\u016b':b.append(z?'U':'u');break;//u macron
		case '\u016d':b.append(z?'U':'u');break;//u brève
		...
		case '\u1e85':b.append(z?'W':'w');break;//w tréma
		...
		case '\u1e8d':b.append(z?'X':'x');break;//x tréma
		
		case '\u0177':b.append(z?'Y':'y');break;//y accent circonflexe
		case '\u00ff':b.append(z?'Y':'y');break;//ÿ tréma
		case '\u00fd':b.append(z?'Y':'y');break;//ý accent aigu
		...
		case '\u017e':b.append(z?'Z':'z');break;//ž hatchek
