package gus06.entity.gus.dirfile.op.move.replace;
...
public class EntityImpl implements Entity, P {
	...
	{
		moveDir = Outside.service(this,"gus.dir.op.move.replace");
		moveFile = Outside.service(this,"gus.file.op.move.replace");
	}
