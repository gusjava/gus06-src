package gus06.entity.gus.dirfile.op.copy.ignore;
...
public class EntityImpl implements Entity, P {
	...
	{
		copyDir = Outside.service(this,"gus.dir.op.copy.ignore");
		copyFile = Outside.service(this,"gus.file.op.copy.ignore");
	}
