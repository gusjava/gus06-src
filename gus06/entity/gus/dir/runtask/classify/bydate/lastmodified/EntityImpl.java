package gus06.entity.gus.dir.runtask.classify.bydate.lastmodified;
...
public class EntityImpl implements Entity, P {
	...
	private Service getLastModified;
	private Service moveFile;
	
	public EntityImpl() throws Exception
	{
		listing = Outside.service(this,"gus.dir.listing.dirtofiles");
		getLastModified = Outside.service(this,"gus.file.lastmodified.timestamp.yyyymmdd");
	...
	public void p(Object obj) throws Exception
	{
		...
		{
			File f = (File) l.get(i);
			String v = (String) getLastModified.t(f);
