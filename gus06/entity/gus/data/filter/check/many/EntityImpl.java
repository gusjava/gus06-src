package gus06.entity.gus.data.filter.check.many;
...
public class EntityImpl implements Entity, F {
	...
	{
		filterList = Outside.service(this,"gus.list.check.many");
		filterSet = Outside.service(this,"gus.set.check.many");
		filterMap = Outside.service(this,"gus.map.key.check.many");
	}	
