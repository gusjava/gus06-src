package gus06.entity.gus.data.perform.puttoday;
...
public class EntityImpl implements Entity, P, T {
	...
	{
		performMap = Outside.service(this,"gus.map.puttoday");
		performFile = Outside.service(this,"gus.file.properties.perform.field.puttoday");
	}
