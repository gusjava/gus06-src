package gus06.entity.gus.data.perform.keep;
...
public class EntityImpl implements Entity, P, T {
	...
	{
		performList = Outside.service(this,"gus.list.keep");
		performSet = Outside.service(this,"gus.set.keep");
		performMap = Outside.service(this,"gus.map.keep");
	}
