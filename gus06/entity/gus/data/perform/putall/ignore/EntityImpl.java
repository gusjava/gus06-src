package gus06.entity.gus.data.perform.putall.ignore;
...
public class EntityImpl implements Entity, P, T {
	...
	{
		performMap = Outside.service(this,"gus.map.putall.ignore");
		performFile = Outside.service(this,"gus.file.properties.perform.field.putall.ignore");
	}
