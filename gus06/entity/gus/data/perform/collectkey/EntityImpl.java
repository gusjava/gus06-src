package gus06.entity.gus.data.perform.collectkey;
...
public class EntityImpl implements Entity, P, T {
	...
	{
		performFile = Outside.service(this,"gus.dirfile.perform.eachkey.transform");
		performMap = Outside.service(this,"gus.map.key.collect");
	}
