package gus06.entity.gus.data.perform.trim.end;
...
public class EntityImpl implements Entity, T {
	...
	{
		performString = Outside.service(this,"gus.string.transform.str.trim.end");
		performList = Outside.service(this,"gus.list.trim.end");
		performArray = Outside.service(this,"gus.array.trim.end");
	}
