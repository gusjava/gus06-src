package gus06.entity.gus.data.perform.mapkey3;
...
public class EntityImpl implements Entity, T {
	...
	{
		performList = Outside.service(this,"gus.list.mapkey3");
		performArray = Outside.service(this,"gus.array.objectarray.mapkey3");
	}	
