package gus06.entity.gus.data.perform.collect2;
...
public class EntityImpl implements Entity, P, T {
	...
	{
		performList = Outside.service(this,"gus.list.collect2");
		performSet = Outside.service(this,"gus.set.collect2");
		performArray = Outside.service(this,"gus.array.objectarray.collect2");
	}
