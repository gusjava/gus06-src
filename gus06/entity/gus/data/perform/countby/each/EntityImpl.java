package gus06.entity.gus.data.perform.countby.each;
...
public class EntityImpl implements Entity, T {
	...
	{
		performList = Outside.service(this,"gus.list.countby.each");
		performSet = Outside.service(this,"gus.set.countby.each");
