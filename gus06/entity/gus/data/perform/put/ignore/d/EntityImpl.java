package gus06.entity.gus.data.perform.put.ignore.d;
...
public class EntityImpl implements Entity, P, T {
	...
	{
		performMap = Outside.service(this,"gus.map.put.ignore.d");
		performFile = Outside.service(this,"gus.file.properties.perform.field.put.ignore.d");
	}
