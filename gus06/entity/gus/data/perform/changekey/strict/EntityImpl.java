package gus06.entity.gus.data.perform.changekey.strict;
...
public class EntityImpl implements Entity, P, T {
	...
	{
		performMap = Outside.service(this,"gus.map.key.change.strict");
		performFile = Outside.service(this,"gus.file.properties.perform.field.rename.strict");
	}
