package gus06.entity.gus.data.perform.changekey;
...
public class EntityImpl implements Entity, P, T {
	...
	{
		performMap = Outside.service(this,"gus.map.key.change");
		performFile = Outside.service(this,"gus.file.properties.perform.field.rename");
	}
