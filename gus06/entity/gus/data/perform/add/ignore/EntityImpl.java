package gus06.entity.gus.data.perform.add.ignore;
...
public class EntityImpl implements Entity, P, T {
	...
	{
		performSet = Outside.service(this,"gus.set.add.ignore");
		performList = Outside.service(this,"gus.list.add.ignore");
	}
