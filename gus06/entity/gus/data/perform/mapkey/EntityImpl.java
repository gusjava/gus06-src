...
public class EntityImpl implements Entity, T {
	...
	{
		performList = Outside.service(this,"gus.list.mapkey");
		performSet = Outside.service(this,"gus.set.mapkey");
		performArray = Outside.service(this,"gus.array.objectarray.mapkey");
	}	
