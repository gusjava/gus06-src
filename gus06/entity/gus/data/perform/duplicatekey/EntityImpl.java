package gus06.entity.gus.data.perform.duplicatekey;
...
public class EntityImpl implements Entity, P, T {
	...
	{
		performMap = Outside.service(this,"gus.map.key.duplicate");
		performFile = Outside.service(this,"gus.file.properties.perform.field.duplicate");
	}
