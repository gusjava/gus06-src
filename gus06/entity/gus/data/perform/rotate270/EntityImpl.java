package gus06.entity.gus.data.perform.rotate270;
...
public class EntityImpl implements Entity, T {
	...
	{
		rotateJPanel = Outside.service(this,"gus.swing.panel.rotate270.grid");
		rotateJTabbedPane = Outside.service(this,"gus.swing.tabbedpane.rotate270");
		rotateJSplitPane = Outside.service(this,"gus.swing.splitpane.rotate270");
		rotateImage = Outside.service(this,"gus.awt.renderedimage.transform.rotate270");
	}
