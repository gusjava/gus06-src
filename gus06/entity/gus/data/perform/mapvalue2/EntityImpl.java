package gus06.entity.gus.data.perform.mapvalue2;
...
public class EntityImpl implements Entity, T {
	...
	{
		performList = Outside.service(this,"gus.list.mapvalue2");
		performSet = Outside.service(this,"gus.set.mapvalue2");
		performArray = Outside.service(this,"gus.array.objectarray.mapvalue2");
	}	
