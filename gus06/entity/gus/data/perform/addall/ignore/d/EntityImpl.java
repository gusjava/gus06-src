package gus06.entity.gus.data.perform.addall.ignore.d;
...
public class EntityImpl implements Entity, P, T {
	...
	{
		performSet = Outside.service(this,"gus.set.addall.ignore.d");
		performList = Outside.service(this,"gus.list.addall.ignore.d");
	}
