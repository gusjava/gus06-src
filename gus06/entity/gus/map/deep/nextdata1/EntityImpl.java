package gus06.entity.gus.map.deep.nextdata1;
...
public class EntityImpl implements Entity, T {
	...
	{
		map = Outside.service(this,"gus.map.deep.nextdata1.map");
		list = Outside.service(this,"gus.map.deep.nextdata1.list");
		set = Outside.service(this,"gus.map.deep.nextdata1.set");
