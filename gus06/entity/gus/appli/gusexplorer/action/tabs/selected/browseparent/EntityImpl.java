package gus06.entity.gus.appli.gusexplorer.action.tabs.selected.browseparent;
...
public class EntityImpl implements Entity, G, E {
	...
	{
		execute = Outside.service(this,"gus.appli.gusexplorer.execute.tabs.selected.browseparent");
