package gus06.entity.gus.appli.gusexplorer.execute.tabs.add.scriptdir.startup;
...
public class EntityImpl implements Entity, E {
	...
	public EntityImpl() throws Exception
	{
		...
		dirHolder = Outside.service(this,"gus.appli.gusexplorer.scripts.startup.manager");
	}
