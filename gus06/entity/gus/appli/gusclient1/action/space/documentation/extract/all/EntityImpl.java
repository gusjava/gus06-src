package gus06.entity.gus.appli.gusclient1.action.space.documentation.extract.all;
...
public class EntityImpl implements Entity, E, G {
	...
	{
		execute = Outside.service(this,"gus.appli.gusclient1.execute.space.documentation.extract.all");
