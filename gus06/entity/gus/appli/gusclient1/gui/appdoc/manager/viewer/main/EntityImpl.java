package gus06.entity.gus.appli.gusclient1.gui.appdoc.manager.viewer.main;
...
public class EntityImpl implements Entity, I, ActionListener {
	...
	{
		selector = Outside.service(this,"*gus.appli.gusclient1.gui.appdoc.manager.viewer.main.selector");
