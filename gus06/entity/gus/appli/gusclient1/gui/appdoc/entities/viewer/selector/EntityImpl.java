package gus06.entity.gus.appli.gusclient1.gui.appdoc.entities.viewer.selector;
...
public class EntityImpl extends S1 implements Entity, I, G, ActionListener, ListSelectionListener {
	...
	public EntityImpl() throws Exception
	{
		...
		buildKeys = Outside.service(this,"gus.appli.gusclient1.gui.appdoc.entities.viewer.selector.buildkeys");
