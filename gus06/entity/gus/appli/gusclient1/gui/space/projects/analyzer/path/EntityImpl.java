package gus06.entity.gus.appli.gusclient1.gui.space.projects.analyzer.path;
...
public class EntityImpl implements Entity, ActionListener, I {
	...
	{
		loadConfig = Outside.service(this,"gus.appli.gusclient1.project.config.load2.path");
